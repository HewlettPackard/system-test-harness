...
test_case_begin "Real time events translation: alarm clearance"
test_case_goal "Check that productA can produce proper clearance events that correlate well"
